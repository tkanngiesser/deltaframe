...
__all__ = ['get_added_rows', 'get_removed_rows', 'get_modified_rows', 'show_delta', 'log_delta']
...
# Cell
def show_delta(df_old, df_new, unique_id, sort_by=None, trans_col="transaction", trans_val_added="added", trans_val_removed="removed", trans_val_modified="modified"):
    added_rows = get_added_rows(df_old=df_old, df_new=df_new, unique_id="id",trans_col=trans_col, trans_vaL=trans_val_added)
    removed_rows = get_removed_rows(df_old=df_old, df_new=df_new, unique_id="id", trans_col=trans_col, trans_val=trans_val_removed)
    modified_rows = get_modified_rows(df_old=df_old, df_new=df_new, unique_id="id", added_rows=added_rows, trans_col=trans_col, trans_val=trans_val_modified)
